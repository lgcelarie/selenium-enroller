...
def obtain_promos(driver):
    ...
    select_options = Select(driver.find_element(By.NAME, "promocion")).getOptions()

    for word in keywords:
        for option in select_options:
            text = option.getText()
            if text != None and text.contains(current_mont_and_year) and text.contains(word):
                return_dict[word] = option.getValue()
    ...
    for cliente in clientes:
        ...
        for promo in promociones:
            ...
            # Encuentra los campos del formulario y los completa
                ...
                select_promocion.select_by_value(available_promos[promo])
